...
$(function(){function e(){$(".carousel-services-item").each(function(){var e=$(this),i=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-image").css("min-height",i)})}function i(){$(".carousel-services-content").equalHeights()}$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo-2.png" alt="DOCC - студия дизайна мебели">'},offCanvas:{position:"right"},pageScroll:!0,slidingSubmenus:!1,onClick:{close:!0,preventDefault:!1}}),$("#my-menu").data("mmenu").bind("open:finish",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-services").owlCarousel({loop:!0,nav:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),e(),$(".carousel-services-composition .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$("select").selectize({}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1,autoHeight:!0}),$(".partners").owlCarousel({loop:!0,smartSpeed:700,dots:!1,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(document).ready(function(){$("#my-menu").on("click","a",function(e){e.preventDefault();var i=$(this).attr("href"),s=$(i).offset().top;$("body,html").animate({scrollTop:s},1e3)})}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),function(){var i={height:205,width:803,zoom:17,queryString:"улица Ивана Мазепы, 57, Чернигов, Chernihiv Oblast, Ukraine",place_id:"ElPRg9C70LjRhtCwINCY0LLQsNC90LAg0JzQsNC30LXQv9GLLCA1Nywg0KfQtdGA0L3QuNCz0L7QsiwgQ2hlcm5paGl2IE9ibGFzdCwgVWtyYWluZSIwEi4KFAoSCV9kPrC0SNVGEVakrIKax4YWEDkqFAoSCdPRFgm7SNVGEeZlcVaLjPJ9",satellite:!1,centerCoord:[51.47203771994427,31.257729100000006],cid:"0xa0394f7665e9d437",cityUrl:"/ukraine/staryy-belous-459160",id:"map-9cd199b9cc5410cd3b1ad21cab2e54d3",embed_id:"82900"},e=document,s=e.createElement("script");s.src="https://1map.com/js/script-for-user.js?embed_id=82900",s.async=!0,s.onload=function(e){window.OneMap.initMap(i)};var t=e.getElementsByTagName("script")[0];t.parentNode.insertBefore(s,t)}(),i(),window.onresize=function(){i()},window.onresize=function(){e()}}),$(window).on("load",function(){$(".preloader").delay(1500).fadeOut("slow")});